...
/**
 * class Gring_Validator_Rule_ChsAlphaDashRule
 */
class Gring_Validator_Rule_ChsAlphaDashRule extends Gring_Validator_Contract_RuleAbstract
{
    /**
     * @var
     */
    ...
    public function validate($data, $propertyName, $item)
    {
        ...
        /* @var Gring_Validator_Mapping_ChsAlphaDash $item */
