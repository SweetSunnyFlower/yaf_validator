...
/**
 * class Gring_Validator_Rule_ChsAlphaNumRule
 */
class Gring_Validator_Rule_ChsAlphaNumRule extends Gring_Validator_Contract_RuleAbstract
{
    /**
     * @var
     */
    ...
    public function validate($data, $propertyName, $item)
    {
        ...
        /* @var Gring_Validator_Mapping_ChsAlphaNum $item */
