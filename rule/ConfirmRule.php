...
/**
 * class Gring_Validator_Rule_ConfirmRule
 */
class Gring_Validator_Rule_ConfirmRule extends Gring_Validator_Contract_RuleAbstract
{
    /**
     * @var
     */
    ...
    public function validate($data, $propertyName, $item)
    {
        ...
        /* @var Gring_Validator_Mapping_Confirm $item */
