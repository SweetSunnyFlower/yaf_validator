...
/**
 * class Gring_Validator_Rule_MobileRule
 */
class Gring_Validator_Rule_MobileRule extends Gring_Validator_Contract_RuleAbstract
{
    /**
     * @var
     */
    ...
    public function validate($data, $propertyName, $item)
    {
        ...
        /* @var Gring_Validator_Mapping_Mobile $item */
        $value = $data[$propertyName];
        if (Gring_Validator_Helper_Validator::validateMobile($value)) {
            return $data;
        }
