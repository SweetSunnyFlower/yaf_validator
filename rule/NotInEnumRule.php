...
/**
 * class Gring_Validator_Rule_NotInEnumRule
 */
class Gring_Validator_Rule_NotInEnumRule extends Gring_Validator_Contract_RuleAbstract
{
    /**
     * @var
     */
    ...
    public function validate($data, $propertyName, $item)
    {
        ...
        /* @var Gring_Validator_Mapping_NotInEnum $item */
