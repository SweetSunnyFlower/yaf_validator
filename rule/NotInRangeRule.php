...
/**
 * class Gring_Validator_Rule_NotInRangeRule
 */
class Gring_Validator_Rule_NotInRangeRule extends Gring_Validator_Contract_RuleAbstract
{
    /**
     * @var
     */
    ...
    public function validate($data, $propertyName, $item)
    {
        ...
        /* @var Gring_Validator_Mapping_NotInRange $item */
        $min = $item->getMin();
        $max = $item->getMax();
