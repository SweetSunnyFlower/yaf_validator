...
/**
 * class Gring_Validator_Rule_PatternRule
 */
class Gring_Validator_Rule_PatternRule extends Gring_Validator_Contract_RuleAbstract
{
    /**
     * @var
     */
    ...
    public function validate($data, $propertyName, $item)
    {
        ...
        /* @var Gring_Validator_Mapping_Pattern $item */
        $regex = $item->getRegex();
        $value = $data[$propertyName];
        if (Gring_Validator_Helper_Validator::validatePattern($value, $regex)) {
            return $data;
        }
